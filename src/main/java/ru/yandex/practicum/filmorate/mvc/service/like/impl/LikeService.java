package ru.yandex.practicum.filmorate.mvc.service.like.impl;
...
public class LikeService implements LikeAppService {
	...
	public LikeService(@Qualifier("dbLikeStorage") LikeAppStorage likeAppStorage, ExceptionChecker exceptionsChecker,
