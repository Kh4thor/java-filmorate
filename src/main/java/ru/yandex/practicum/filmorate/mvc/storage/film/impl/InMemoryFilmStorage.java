...
@Component
public class InMemoryFilmStorage implements FilmAppStorage<Film> {
	...
	public List<Film> getRatedFilms(List<Long> ratedFilmsIdList) {
		...
		return ratedFilmsIdList.stream().map(id -> filmsStorageMap.get(id)).toList();
	}
	...
	public List<Film> getAllFilms() {
		return filmsStorageMap.values().stream().toList();
	}
